...
class Chatbot {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Chatbot_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Chatbot_Loader. Orchestrates the hooks of the plugin.
	 * - Chatbot_i18n. Defines internationalization functionality.
	 * - Chatbot_Admin. Defines all hooks for the admin area.
	 * - Chatbot_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Chatbot_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_footer', $plugin_public, 'register_chatbot' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Chatbot_Loader    Orchestrates the hooks of the plugin.
	 */
